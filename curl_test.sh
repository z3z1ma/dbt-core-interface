...
curl -X POST -H "Content-Type: application/json" -H "X-dbt-Project: dbt_project" -G -d 'sql_path=/app/tests/sqlfluff_templater/fixtures/dbt/dbt_project/models/my_new_project/issue_1608.sql' http://localhost:8581/lint_sql
